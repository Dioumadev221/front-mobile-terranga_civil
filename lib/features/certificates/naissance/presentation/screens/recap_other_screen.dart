    ...
    Future<void> submit() async {
      try {
        final id = await ref.read(naissanceProvider.notifier).submit(
              ...
              anneeRegistre: formData['annee_registre'] as String,
        ...
        // Si l'envoi des pièces d'identité a échoué, on prévient
        // l'utilisateur (mais on continue vers le paiement : le dossier
        // a bien été créé).
              ...
              RecapCard(
                ...
                fields: [
                  ...
                  RecapField(
                    ...
                    value: formData['annee_registre'] as String,
